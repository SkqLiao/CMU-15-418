...
void _cmu418_vstore_float(float *dest, __cmu418_vec_float &src, __cmu418_mask &mask) {
    _cmu418_vstore<float>(dest, src, mask);
}
void _cmu418_vstore_int(int *dest, __cmu418_vec_int &src, __cmu418_mask &mask) {
    _cmu418_vstore<int>(dest, src, mask);
}

template <typename T>
void _cmu418_vadd(__cmu418_vec<T> &vecResult, __cmu418_vec<T> &veca, __cmu418_vec<T> &vecb,
                  __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
...
template void _cmu418_vadd<float>(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca,
                                  __cmu418_vec_float &vecb, __cmu418_mask &mask);
template void _cmu418_vadd<int>(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                                __cmu418_mask &mask);

void _cmu418_vadd_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca, __cmu418_vec_float &vecb,
                        __cmu418_mask &mask) {
    _cmu418_vadd<float>(vecResult, veca, vecb, mask);
}
void _cmu418_vadd_int(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                      __cmu418_mask &mask) {
    _cmu418_vadd<int>(vecResult, veca, vecb, mask);
}

template <typename T>
void _cmu418_vsub(__cmu418_vec<T> &vecResult, __cmu418_vec<T> &veca, __cmu418_vec<T> &vecb,
                  __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
        vecResult.value[i] = mask.value[i] ? (veca.value[i] - vecb.value[i]) : vecResult.value[i];
    }
...
template void _cmu418_vsub<float>(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca,
                                  __cmu418_vec_float &vecb, __cmu418_mask &mask);
template void _cmu418_vsub<int>(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                                __cmu418_mask &mask);

void _cmu418_vsub_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca, __cmu418_vec_float &vecb,
                        __cmu418_mask &mask) {
    _cmu418_vsub<float>(vecResult, veca, vecb, mask);
}
void _cmu418_vsub_int(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                      __cmu418_mask &mask) {
    _cmu418_vsub<int>(vecResult, veca, vecb, mask);
}

template <typename T>
void _cmu418_vmult(__cmu418_vec<T> &vecResult, __cmu418_vec<T> &veca, __cmu418_vec<T> &vecb,
                   __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
        vecResult.value[i] = mask.value[i] ? (veca.value[i] * vecb.value[i]) : vecResult.value[i];
    }
...
template void _cmu418_vmult<float>(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca,
                                   __cmu418_vec_float &vecb, __cmu418_mask &mask);
template void _cmu418_vmult<int>(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                                 __cmu418_mask &mask);

void _cmu418_vmult_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca, __cmu418_vec_float &vecb,
                         __cmu418_mask &mask) {
    _cmu418_vmult<float>(vecResult, veca, vecb, mask);
}
void _cmu418_vmult_int(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                       __cmu418_mask &mask) {
    _cmu418_vmult<int>(vecResult, veca, vecb, mask);
}

template <typename T>
void _cmu418_vdiv(__cmu418_vec<T> &vecResult, __cmu418_vec<T> &veca, __cmu418_vec<T> &vecb,
                  __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
        vecResult.value[i] = mask.value[i] ? (veca.value[i] / vecb.value[i]) : vecResult.value[i];
    }
...
void _cmu418_vshiftright_int(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                             __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++)
        vecResult.value[i] = mask.value[i] ? (veca.value[i] >> vecb.value[i]) : vecResult.value[i];
}

void _cmu418_vbitand_int(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                         __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++)
        vecResult.value[i] = mask.value[i] ? (veca.value[i] & vecb.value[i]) : vecResult.value[i];
}
...
template void _cmu418_vdiv<float>(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca,
                                  __cmu418_vec_float &vecb, __cmu418_mask &mask);
template void _cmu418_vdiv<int>(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                                __cmu418_mask &mask);

void _cmu418_vdiv_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca, __cmu418_vec_float &vecb,
                        __cmu418_mask &mask) {
    _cmu418_vdiv<float>(vecResult, veca, vecb, mask);
}
void _cmu418_vdiv_int(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                      __cmu418_mask &mask) {
    _cmu418_vdiv<int>(vecResult, veca, vecb, mask);
}
...
template void _cmu418_vabs<float>(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca,
                                  __cmu418_mask &mask);
...
void _cmu418_vabs_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &veca, __cmu418_mask &mask) {
    _cmu418_vabs<float>(vecResult, veca, mask);
}
void _cmu418_vabs_int(__cmu418_vec_int &vecResult, __cmu418_vec_int &veca, __cmu418_mask &mask) {
    _cmu418_vabs<int>(vecResult, veca, mask);
}

template <typename T>
void _cmu418_vgt(__cmu418_mask &maskResult, __cmu418_vec<T> &veca, __cmu418_vec<T> &vecb,
                 __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
...
template void _cmu418_vgt<float>(__cmu418_mask &maskResult, __cmu418_vec_float &veca,
                                 __cmu418_vec_float &vecb, __cmu418_mask &mask);
template void _cmu418_vgt<int>(__cmu418_mask &maskResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                               __cmu418_mask &mask);

void _cmu418_vgt_float(__cmu418_mask &maskResult, __cmu418_vec_float &veca, __cmu418_vec_float &vecb,
                       __cmu418_mask &mask) {
    _cmu418_vgt<float>(maskResult, veca, vecb, mask);
}
void _cmu418_vgt_int(__cmu418_mask &maskResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                     __cmu418_mask &mask) {
    _cmu418_vgt<int>(maskResult, veca, vecb, mask);
}

template <typename T>
void _cmu418_vlt(__cmu418_mask &maskResult, __cmu418_vec<T> &veca, __cmu418_vec<T> &vecb,
                 __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
        maskResult.value[i] = mask.value[i] ? (veca.value[i] < vecb.value[i]) : maskResult.value[i];
    }
...
template void _cmu418_vlt<float>(__cmu418_mask &maskResult, __cmu418_vec_float &veca,
                                 __cmu418_vec_float &vecb, __cmu418_mask &mask);
template void _cmu418_vlt<int>(__cmu418_mask &maskResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                               __cmu418_mask &mask);

void _cmu418_vlt_float(__cmu418_mask &maskResult, __cmu418_vec_float &veca, __cmu418_vec_float &vecb,
                       __cmu418_mask &mask) {
    _cmu418_vlt<float>(maskResult, veca, vecb, mask);
}
void _cmu418_vlt_int(__cmu418_mask &maskResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                     __cmu418_mask &mask) {
    _cmu418_vlt<int>(maskResult, veca, vecb, mask);
}

template <typename T>
void _cmu418_veq(__cmu418_mask &maskResult, __cmu418_vec<T> &veca, __cmu418_vec<T> &vecb,
                 __cmu418_mask &mask) {
    for (int i = 0; i < VECTOR_WIDTH; i++) {
        maskResult.value[i] = mask.value[i] ? (veca.value[i] == vecb.value[i]) : maskResult.value[i];
    }
...
template void _cmu418_veq<float>(__cmu418_mask &maskResult, __cmu418_vec_float &veca,
                                 __cmu418_vec_float &vecb, __cmu418_mask &mask);
template void _cmu418_veq<int>(__cmu418_mask &maskResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                               __cmu418_mask &mask);

void _cmu418_veq_float(__cmu418_mask &maskResult, __cmu418_vec_float &veca, __cmu418_vec_float &vecb,
                       __cmu418_mask &mask) {
    _cmu418_veq<float>(maskResult, veca, vecb, mask);
}
void _cmu418_veq_int(__cmu418_mask &maskResult, __cmu418_vec_int &veca, __cmu418_vec_int &vecb,
                     __cmu418_mask &mask) {
    _cmu418_veq<int>(maskResult, veca, vecb, mask);
}
...
void _cmu418_hadd_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &vec) {
    _cmu418_hadd<float>(vecResult, vec);
}
...
void _cmu418_interleave_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &vec) {
    _cmu418_interleave<float>(vecResult, vec);
}
